...
| [`NiRe_Notepad`](NiRe_Notepad) | `NiReNotepad` | `24B93F548304474B` | Persistent field notepad on a rebindable key, in game and on the map. Fixed CAS, Artillery and MEDEVAC templates, free notes, a drawing canvas, and faction-shared Supply Requests with requester and logistician roles. |
